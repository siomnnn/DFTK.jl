...
# TODO: FEMize
#function Kpoint(basis::FiniteElementBasis, coordinate::AbstractVector, spin::Int)
...
#function get_kpoint(basis::FiniteElementBasis{T}, kcoord, spin) where {T}
...
#function FiniteElementBasis(model::Model{T}, Ecut::Real, fft_size::Tuple{Int, Int, Int},
...
# TODO: FEMize if necessary. What is a G vector? Discretization points in Fourier space? So, replace with Gridap dofs?
#@doc raw"""
...
# TODO: FEMize if necessary. What is an r vector?
#@doc raw"""
...
# TODO: FEMize. What does this even do?
#"""
...
"""
function irreducible_kcoords_global(basis::FiniteElementBasis)
...
function irreducible_kweights_global(basis::FiniteElementBasis{T}) where {T}
...
"""
@views function gather_kpts_block!(dest, basis::FiniteElementBasis, kdata::AbstractVector{A}) where {A}
...
function gather_kpts_block(basis::FiniteElementBasis, kdata::AbstractVector{A}) where {A}
    dest = nothing
    if mpi_master(basis.comm_kpts)
...
"""
function scatter_kpts_block(basis::FiniteElementBasis, data::Union{Nothing,AbstractArray})
...
# TODO: FEMize if necessary, but likely just delete
#"""
